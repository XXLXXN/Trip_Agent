  ...
  return (
    <div className="h-full overflow-y-auto px-5 pb-24 space-y-4">
      ...
      <div className="mt-6 mb-4">
        <div className="flex items-center gap-3 px-4 py-3 bg-white rounded-2xl border border-[#EBEBEB]">
          <input
            type="text"
            placeholder="请输入需求"
            className="flex-1 text-[14px] text-[#404040] outline-none"
            style={{ fontFamily: 'Inter' }}
          />
          <button className="w-[34px] h-[34px] rounded-[10px] bg-white flex items-center justify-center">
      ...
      {/* Bottom CTA */}
      <FixedBottomButton onClick={() => console.log('修改')}>
        修改
      </FixedBottomButton>
    </div>
  );

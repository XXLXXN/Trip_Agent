          ...
          tripData.days.map((day, dayIndex) => (
            <div key={day.day_index} className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div
                  className="text-[#1B1446] font-bold text-[24px]"
                  style={{ fontFamily: "Inter" }}
                >
                  第{day.day_index}天
                </div>
              ...
              <div className="space-y-4">
                {(() => {
                  ...
                  return day.activities.map((activity, activityIndex) => {
                    ...
                    if (activity.type === "activity") {
                      ...
                      return (
                        <div key={activity.id} className="space-y-3">
                          ...
                          <div className="flex items-center gap-3">
                            <div
                              className="text-[#1B1446] font-semibold text-[20px] leading-[24px]"
                              style={{ fontFamily: "Inter" }}
                            >
                              活动{attractionIndex}
                            </div>
                            <div
                              className="text-[#808080] font-semibold text-[14px] leading-[17px]"
                              style={{ fontFamily: "Inter" }}
                            >
                    ...
                    // 对于 large_transportation 类型，直接显示交通卡片
                    ...
                    if (activity.type === "transportation") {
                      ...
                      const transportationActivities = day.activities.filter(
                        (a) =>
                      ...
                      const isFirstTransportForThisRoute =
                        transportationActivities.indexOf(activity) === 0;
                        ...
                        return (
                          <div key={activity.id} className="space-y-3">
                            ...
                            {(() => {
                              ...
                              const matchingTransport = day.activities.find(
                                (a) =>
                                  a.type === "transportation" &&
                                  a.mode === selectedMode &&
                                  a.origin?.name === originName &&
                              ...
                              const transportData =
                                convertToItineraryData(matchingTransport);
                              return transportData ? (
                                <ItineraryCard
                                  type="transport"
                                  data={transportData.data}

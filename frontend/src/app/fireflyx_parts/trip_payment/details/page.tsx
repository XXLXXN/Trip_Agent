                ...
                {(() => {
                  ...
                  return day.activities.map((activity, activityIndex) => {
                    ...
                    if (activity.type === "activity") {
                      ...
                      const spotData = convertToSpotCardData(activity, false); // details 页面不显示跳转
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-[40%] flex gap-2">
            <button 
              ...
              className="flex-1 h-12 rounded-2xl bg-white text-[#1B1446] font-semibold text-[16px] border border-[#E5E5E5] whitespace-nowrap transition-colors hover:bg-gray-50"
              style={{ fontFamily: 'Inter' }}
            >
              修改
            </button>

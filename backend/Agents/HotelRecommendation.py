...
base_payload = {
    ...
    "bot_app_key": "qvBGXAzLrSbPwueFDVWpVfVuaZMZTjxQuqMQVmzVaXCdYVdczNbUbrSTOHGmYcfNLWjMbikBPvAbSNOstlQEneXWDKedaANnkMjTVoqHnThRPyYVoNThATcDeEXQhyoV",
...
# --- 调试专用的核心功能函数 ---
async def get_hotel_recommendation(content: str) -> list:
    """
...
async def main():
    ...
    print(spot_api_key)
    # 调用核心函数并等待结果
    final_replies = await get_hotel_recommendation(user_input)

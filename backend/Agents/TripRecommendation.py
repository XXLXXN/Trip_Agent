...
base_payload = {
    ...
    "bot_app_key": "aPsHEKvQTfnXtLqnVYlseygWMbEYQZWvddFzIWYAXRXojGMFXHnZiZuBqwNhNEgsPBduqVNoRepxjGUUDrZIXDbOzUOrMicbyduHtBSorYdIZQghUDqafqSQdDsnwSMK",
...
async def main():
  ...
  "HotelSpotsData": {
    ...
    "Spots": [
      ...
      {
        "id": "spot_shanghai_museum",
        "name": "上海博物馆",
        "address": "中国上海市黄浦区人民大道201号",
        "coordinates": {
          "latitude": 31.2307,
          "longitude": 121.4747
        }
    ...
    print(spot_api_key)
    # 调用核心函数并等待结果
    final_replies = await get_trip_recommendation(user_input)

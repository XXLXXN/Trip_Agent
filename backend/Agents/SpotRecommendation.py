...
base_payload = {
    ...
    "bot_app_key": "thtprpkQjZcMgPxiSuDHESIkYVvYkIYitXhFPwsafMncoDgtygPfPpzAsDfLvaLlJZcUCTpqpDoyzJGFpVArDyPClSsRBAsyzhwxRvOnqTIAtFDDCfMGTFVIOtPNtSHH",
...
async def main():
    ...
    """
    # 在这里定义你想发送的内容
    user_input = "我们有一个学生和三个成人，想要在2025年11月27日出发去上海玩5天，体验当地文化"
    print(spot_api_key)
    # 调用核心函数并等待结果
    final_replies = await get_spot_recommendation(user_input)

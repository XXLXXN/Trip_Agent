...
// 定义 Header 组件需要的 props 类型
interface HeaderProps {
  onBackClick: () => void; // 返回按钮的点击事件处理函数
  onSkipClick: () => void; // 跳过按钮的点击事件处理函数
}
    ...
    <>
      <div className="header-container">
        <div className="header-left">
          {/* 1. 将SVG图标的填充颜色从 fill="#374151" 改为 fill="white" */}
      ...
      <style jsx>{`
        ...
        /* 2. 更新了 back-button 的样式 */
        .back-button {
          width: 56px;
          height: 37px;
          background-color: rgba(255, 255, 255, 0.2); /* ffffff颜色 20%透明度 */
          border-radius: 18.5px; /* 高度的一半，形成药丸形状 */
          border: none;
          cursor: pointer;
          display: flex;
          align-items: center;

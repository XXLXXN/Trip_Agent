    ...
    <div className={styles.pageContainer}>
      {/* 空白导航栏 */}
        ...
        {/* SVG图标作为主要内容 */}
          ...
          <div className={styles.headerTitle}></div> {/* 空白标题 */}
        </div>
        ...
        <h1 className={styles.successTitle}>完成支付</h1>
        ...
        <div className={styles.steps}>
          <div className={`${styles.step} ${styles.complete}`}>
            ...
            <div className={styles.stepText}>预订</div>
          </div>
          ...
          <div className={`${styles.step} ${styles.complete}`}>
            ...
            <div className={styles.stepText}>支付</div>
          </div>
          ...
          <div className={`${styles.step} ${styles.active}`}>
            ...
            <div className={styles.stepText}>完成</div>
          </div>
        </div>
        
        <div className={styles.orderInfo}>
          <div className={styles.orderTitle}>订单号：</div>
          <div className={styles.orderNumberContainer}>
            <div className={styles.orderNumber}>776476467276</div>
            <button className={styles.copyButton} onClick={copyOrderNumber}>
        ...
        <div className={styles.qrCodeBox}>
          <img src="images/double_code.png" alt="二维码" className={styles.qrCode} />
        </div>
